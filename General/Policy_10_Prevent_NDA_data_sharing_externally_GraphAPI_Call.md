### Graph API Call Sample for Prevent NDA data sharing externally
...
```json
{
    "displayName": "Prevent NDA data sharing externally",
    "description": "Prevent NDA-covered data leaks.",
    "isEnabled": true,
    "mode": "enforce",
    "priority": 1,
    "rules": [
        {
            "id": "rule-28640",
            "name": "Prevent NDA data sharing externally",
            "actions": [
                {
                    "type": "blockAccess"
                }
