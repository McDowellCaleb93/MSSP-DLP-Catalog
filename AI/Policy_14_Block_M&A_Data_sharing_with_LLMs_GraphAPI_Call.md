### Graph API Call Sample for Block M&A Data sharing with LLMs
...
```json
{
    "displayName": "Block M&A Data sharing with LLMs",
    "description": "Prevent sensitive M&A data from LLM exposure.",
    "isEnabled": true,
    "mode": "enforce",
    "priority": 1,
    "rules": [
        {
            "id": "rule-6648",
            "name": "Block M&A Data sharing with LLMs",
            "actions": [
                {
                    "type": "blockAccess"
                }
