### Graph API Call Sample for Block NDA Data sharing with LLMs
...
```json
{
    "displayName": "Block NDA Data sharing with LLMs",
    "description": "Prevent NDA-bound data from being input into LLMs.",
    "isEnabled": true,
    "mode": "enforce",
    "priority": 1,
    "rules": [
        {
            "id": "rule-11764",
            "name": "Block NDA Data sharing with LLMs",
            "actions": [
                {
                    "type": "blockAccess"
                }
